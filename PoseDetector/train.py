...
from modules.get_parameters import (
    get_parameters_conv,
    get_parameters_bn,
        ...
        for batch_data in train_loader:
            ...
            if num_iter % log_after == 0:
                ...
                for loss_idx in range(len(total_losses) // 2):
                    print(
                        "\n".join(
                            ["stage{}_pafs_loss:     {}", "stage{}_heatmaps_loss: {}"]
                        ).format(
                            loss_idx + 1,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--base-lr", type=float, default=4e-5, help="initial learning rate"
    )
    ...
    train(
        args.prepared_train_labels,
        args.train_images_folder,
        args.num_refinement_stages,
        args.base_lr,
        args.batch_size,
