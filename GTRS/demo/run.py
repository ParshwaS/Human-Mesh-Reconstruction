...
def get_joint_setting(mesh_model, joint_category="human36"):
    joint_regressor, joint_num, skeleton, graph_L, graph_perm_reverse = (
        None,
        None,
        None,
        None,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_pose", type=str, default=".", help="path of input 2D pose"
    )
    parser.add_argument(
        "--input_img", type=str, default=".", help="path of input image"
    )
    parser.add_argument(
        "--joint_set",
        type=str,
        default="coco",
        help="choose the topology of input 2D pose from [human36, coco, smpl, mano]",
    )
    ...
    mesh_model = SMPL()
    model, joint_regressor, joint_num, skeleton, graph_L, graph_perm_reverse = (
        get_joint_setting(mesh_model, joint_category=joint_set)
    )
    model = model.cuda()
    ...
    if input_path != ".":  # user specific input
        ...
        print("Please specify the input 2D pose file path")
